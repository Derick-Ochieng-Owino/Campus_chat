      ...
      if (fileSize > 1024 * 1024) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: const Text('Image size must be less than 1MB'),
    ...
    try {
      ...
      final profileData = {
        ...
        'phone_number': personal
            .phoneNumber, // Added phone number if available in PersonalDetailsData
        // --- Metadata ---
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: TextButton(
                                onPressed:
                                    _saveAllProfileData, // Saves without a photo
                                child: Text(
                                  'SKIP FOR NOW',
